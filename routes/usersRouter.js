...
const { registerUser, loginUser, logout, cart, discountedProducts, addToCart, myaccount, myAcountDetails, changeDetails } = require("../controllers/authController");
...
router.post("/myaccountDetails", isLoggendIn, upload.single("image"),  myAcountDetails);
